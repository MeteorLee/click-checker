...
const SCENARIO = __ENV.SCENARIO || 'R3';
const RUN_ID = __ENV.RUN_ID || `r3-manual-${Date.now()}`;
...
const TO = __ENV.TO;
const BUCKET = __ENV.BUCKET || 'hour';
const TIMEZONE = __ENV.TIMEZONE || 'UTC';
...
export default function () {
  ...
  const url = `${BASE_URL}/api/v1/events/analytics/aggregates/time-buckets?${params.join('&')}`;
