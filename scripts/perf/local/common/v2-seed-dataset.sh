...
DATASET_DIR="${DATASET_DIR:-artifacts/perf/local/common/datasets/${DATASET_VERSION}}"
DATASET_META_PATH="${DATASET_META_PATH:-${DATASET_DIR}/dataset.json}"
ORG_NAME_PREFIX="${ORG_NAME_PREFIX:-perf-v2-local}"
RESET_DATASET="${RESET_DATASET:-false}"
DATASET_CREATED="false"

cleanup_v2_local_dataset_dir() {
  local exit_code=$?
...
main() {
  ...
  trap cleanup_v2_local_dataset_dir EXIT INT TERM
