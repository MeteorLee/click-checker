...
class AdminRouteAnalyticsControllerIntegrationTest extends AnalyticsControllerIntegrationTestSupport {
    ...
    @Test
    void routes_returnsAggregatedRoutes_whenRequesterIsViewer() throws Exception {
        ...
        saveEvent(organization, eventUser, "click", "/posts/1", "2026-02-12T15:10:00Z");
        saveEvent(organization, eventUser, "click", "/posts/2", "2026-02-12T15:20:00Z");
        saveEvent(organization, eventUser, "click", "/landing", "2026-02-12T15:30:00Z");

        mockMvc.perform(
                        get("/api/v1/admin/organizations/{organizationId}/analytics/routes", organization.getId())
    ...
    @Test
    void routes_returnsForbidden_whenRequesterIsNotMember() throws Exception {
        Organization organization = saveOrganization("acme");
    ...
    @Test
    void routes_returnsBadRequest_whenFromIsNotBeforeTo() throws Exception {
        Organization organization = saveOrganization("acme");
        Account viewer = saveAccount("viewer01");
        saveMembership(viewer, organization, OrganizationRole.VIEWER);
    ...
    @Test
    void routes_returnsBadRequest_whenRangeExceedsNinetyDays() throws Exception {
        Organization organization = saveOrganization("acme");
